...
| 3 | API First | รอคำสั่ง |
| 4 | Static Website ด้วย Requests และ BeautifulSoup | รอคำสั่ง |
| 5 | Pagination และการดาวน์โหลดไฟล์ | รอคำสั่ง |
...
หลังตรวจสอบ Phase 2 แล้ว ให้สั่งให้ดำเนินการ **Phase 3** โดยตรง การดำเนินการครั้งถัดไปจะตรวจสอบ Repository ปัจจุบันก่อนเริ่มสร้างไฟล์ของ Phase 3
